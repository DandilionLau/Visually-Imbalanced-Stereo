CUDA_LAUNCH_BLOCKING=1 python train.py --only_test 1 --input_nc 3 --dataset toy_kitti --gpu_num 1 --lr 1e-5 --nEpochs 100 --loss Smooth-L1 --batchSize 1 --testBatchSize 1 --loading_weights 1 --scale_factor 1 \
